...
public class OldObjectUtilities {
	...
	public boolean waitForObject(WebElement element) {
		return waitForObject(element);
	}

	public boolean waitForObject(String xpath) {
		return waitForObject(xpath);
	}
	
	
	public void typeInElement1(String xpath, String content) throws ElementNotLocatedOnUIException {
		typeInElement1(xpath, content, Setup.defaultTimeOutForObjectWait);	}
	
	public void typeInElement1(String xpath, String content, int timeoutInSec) throws ElementNotLocatedOnUIException {
...
//			Reporter__log("Typed successfully into WebElement: \"" + xpath + "\", content: \"" + content + "\"");
	...
	public boolean waitForObject(String xpath, Duration timeoutInSec) {
		@SuppressWarnings("deprecation")
		WebDriverWait wait = new WebDriverWait(driver, timeoutInSec);
		try {
	...
	public void clickElementByJS(WebElement element) throws Exceptions.ElementNotLocatedOnUIException {
